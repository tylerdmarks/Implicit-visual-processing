...
fix_duration_max = 3;       % seconds, max duration of initial fixation
...
ID = 'TDM_simplesaccade_rec1_211102';
...
while state.runningYN
    ...
    % Show fixation point for some period of time
    % randomize frames 
    curr_fix_duration = param.fix_duration_min + rand*(param.fix_duration_max - param.fix_duration_min);
